...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="This script parses command-line arguments and will run PhenVar pipeline: ncbiutils, lanpros, and wordcloudfornouns")
